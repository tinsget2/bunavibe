<?php
    ...
    $giftAlies = $input->giftAlies;
    $numberOfGift = $input->numberOfGift;
    ...
    $query = "INSERT INTO `giftperchase`(`perchaseAlies`, `giftOwner`, `giftAlies`, `numberOfGift`) VALUES (?,?,?,?)";
    $value = array($perchaseAlies, $alies, $giftAlies, $numberOfGift);
    $type = 'ssss';
