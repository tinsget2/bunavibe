<?php
    ...
    $query = "INSERT INTO `education`(`alies`, `eduAlies`, `degreeType`, `graduatedIn`, `graduatedFrom`, `description`, `startDate`, `endDate`) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
    $value = array($alies, $eduAlias, $degreeType, $graduatedIn, $graduatedFrom, $description, $startDate, $endDate);
    $type = 'ssssssss';
